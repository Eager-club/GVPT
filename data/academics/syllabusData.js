const syllabusData = {
    postGraduatePrograms: [
        ...
        { text: "MSc Organic Chemistry Syllabus", link: "URL_TO_MSC_OC_SYLLABUS" },
        { text: "Master of Human Resource Management (MHRM) Syllabus", link: "URL_TO_MHRM_SYLLABUS" }
    ],
    undergraduateEngineeringPrograms: [
        { text: "Engineering & Technology Civil Engineering Syllabus", link: "URL_TO_CIVIL_ENGINEERING_SYLLABUS" },
        { text: "Engineering & Technology Computer Science & Engineering Syllabus", link: "URL_TO_CSE_SYLLABUS" },
        { text: "Engineering & Technology Computer Science & Engineering (Artificial Intelligence & Machine Learning) Syllabus", link: "URL_TO_CSE_AIML_SYLLABUS" },
        { text: "Engineering & Technology Electronics and Communication Engineering Syllabus", link: "URL_TO_ECE_SYLLABUS" },
        { text: "Engineering & Technology Mechanical Engineering Syllabus", link: "URL_TO_MECHANICAL_ENGINEERING_SYLLABUS" }
    ],
